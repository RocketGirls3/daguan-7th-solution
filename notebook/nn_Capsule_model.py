...
output_pro_dir = '../pro/prob_capsule_baseline2.csv'
output_dir = '../output/sub_capsule_baseline2.csv'
output_pkl_dir = '../feature/capsule2.pkl'
...
def get_model():
    ...
    x = Bidirectional(CuDNNGRU(256, return_sequences=True))(embed_layer)
